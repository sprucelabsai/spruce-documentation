...
```bash
cd katas
spruce create.skill {{ kata_name }}-kata
```
...
* Name: `{{ kata_name | capitalize }} Kata`
* Description: `A kata to practice creating {{ kata_name }}!`
...
2. Select "Behavioral"
3. For "What are you testing?", type "{{ what_are_you_testing }}"
4. For "Camel case name", hit Enter (it should say "{{ what_are_you_testing | camelCase }}")
...
2. Delete `class {{ what_are_you_testing | pascalCase }} {}` at the bottom of the test file
